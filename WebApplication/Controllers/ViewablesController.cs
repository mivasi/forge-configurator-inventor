...
namespace WebApplication.Controllers
{
    ...
    public class ViewablesController : ControllerBase
    {
        ...
        public async Task<string> ListAsync()
        {
            ...
            Autodesk.Forge.Client.ApiResponse<dynamic> response = await twoLeggedApi.AuthenticateAsyncWithHttpInfo(_configuration.ClientId, _configuration.ClientSecret, oAuthConstants.CLIENT_CREDENTIALS, new Scope[] { Scope.DataRead });
