...
class JobManager {
    ...
    async doUpdateJob(projectId, currentHash, parameters, onStart, onComplete, onError) {
        ...
        await connection.invoke('CreateUpdateJob', projectId, currentHash, parameters, repo.getAccessToken());
    }
